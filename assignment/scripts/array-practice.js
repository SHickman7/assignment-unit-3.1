...
let favoriteFoods = [ 'fajitas', 'fish and chips', 'grilled cheese', 'sushi', 'caramel apples'];
...
console.log('The color that was removed from the colors array is:', lastColor);
console.log('The updated color array is now', colors);
...
console.log( 'Removed the first color, which was', firstColor);
console.log( 'The update color array is now', colors);
...
console.log( 'The gemString variable looks like this', gemString);
